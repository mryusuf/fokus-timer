...
class TimeTrackerViewModel: ObservableObject {
  ...
  private let longActivityReminderTime = 7200.0
  private let longActivityReminderTitle = "Just Checking In..."
  private var longActivityReminderBody = "You've been doing an activity for 2 hours. "
...
//      print("Timer is set \(timerTime) s")
      notifications.append(NotificationText(id: "main-timer", title: "Congrats!", body: "You have finished your task", timeInterval: Double(timerTime)))
...
//        print("yes cancel")
  ...
  func setLongActivityNotification() {
    var body = ""
    if selectedActivity == .focus_time {
      body = longActivityReminderBody + longActivityFocusString
    } else {
      body = longActivityReminderBody + longActivityBreakString
    }
    notifications.append(NotificationText(id: "longactivity-timer", title: longActivityReminderTitle, body: body, timeInterval: longActivityReminderTime))
//    print(notifications)
